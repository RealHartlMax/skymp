...
11. Для диагностики движения можно включить "show-movement-debug": true (показывает метрики интерполяции/предсказания в HUD-отладке).
12. Если нужно отключить периодическую отправку telemetry по движению на сервер, укажите "send-movement-debug-telemetry": false.
