...
const main = async () => {
  if (mp.get(0x15a6e, 'type') === 'MpActor') {
    ...
    let falmerFaction = mp.callPapyrusFunction(
      'global',
      'Game',
      'GetFormEx',
      null,
    ...
    let fact = mp.callPapyrusFunction(
      'method',
      'Actor',
      'GetFactions',
      selfObject,
    ...
    let isInFalmerFaction = mp.callPapyrusFunction(
      'method',
      'Actor',
      'IsInFaction',
      selfObject,
    ...
    mp.callPapyrusFunction('method', 'Actor', 'RemoveFromFaction', selfObject, [
      falmerFaction,
    ]);

    fact = mp.callPapyrusFunction(
      'method',
      'Actor',
      'GetFactions',
      selfObject,
    ...
    mp.callPapyrusFunction('method', 'Actor', 'AddToFaction', selfObject, [
      falmerFaction,
    ]);
